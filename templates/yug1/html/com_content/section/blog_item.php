...
if ($view->params->get('show_create_date'))
 $article['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '20', 'height' => '20')) . $view->renderCreateDateInfo();
if ($view->params->get('show_modify_date'))
 $article['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '20', 'height' => '20')) . $view->renderModifyDateInfo();
if ($view->params->get('show_publish_date'))
 $article['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '20', 'height' => '20')) . $view->renderPublishDateInfo();

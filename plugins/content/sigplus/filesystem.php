...
* Flat file listing.
*/
function fscandirsorted($folder, $criterion = SIGPLUS_FILENAME, $order = SORT_ASC, array $exceptions = array()) {
	switch ($criterion) {
...
*/
function rscandirsorted($folder, $criterion = SIGPLUS_FILENAME, $order = SORT_ASC, array $exceptions = array(), $depth = 0) {
...
*/
function scandirsorted($folder, $criterion = SIGPLUS_FILENAME, $order = SORT_ASC, array $exceptions = array(), $depth = 0) {
